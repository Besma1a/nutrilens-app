...
// ── Icon map: notification_type → emoji ──────────────────────────────────────
const TYPE_ICON = {
  appointment: "🗓️",
  plan:        "📋",
  message:     "💬",
...
export default function Notifications() {
  ...
  const markAllRead = async () => {
    ...
    try {
      ...
      fetchNotifications(); // Re-fetch to get true state
    }
  };
  ...
  const deleteNotif = async (id) => {
    ...
    try {
      ...
      fetchNotifications(); // Re-fetch if delete failed
    } finally {
      setDeleting(null);
    }
  };
              ...
              {grouped[group].map((n, i) => {
                ...
                return (
                  <div
                    ...
                    onMouseLeave={e => e.currentTarget.style.background = !n.is_read ? "rgba(78,154,120,0.05)" : "white"}
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ fontSize: 12, color: "var(--gray-400)" }}>
                        ...
                        {n.actor_name && (
                          <span style={{ marginLeft: 8, color: "var(--gray-300)" }}>
                            · {n.actor_name}
                          </span>
                        )}
                      </div>
